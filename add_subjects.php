        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Subjects Management <small>Add Subjects </small></h2>
                  ...
                  <div class="x_content">
                   <!--  <p class="text-muted font-13 m-b-30">
                    ...
                    $subject_name=$_POST['subject_name'];
                            ...
                            $que="INSERT INTO `subjects`(`subject_name`, `created_date`,`status`) VALUES ('$subject_name',now(),'1')";
    ...
    <div id="home" class="tab-pane fade in active">
      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="school_name" class="form-control col-md-7 col-xs-12"  name="subject_name" >
