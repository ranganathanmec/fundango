 ...
 <!--  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
  ...
  <?php
                    ...
                    $status=$_POST['status'];
                            ...
                            $que="UPDATE `term`set`term_name`='$term_name',`status`='$status' where `term_id`='$term_id'";
                            $query = mysqli_query($conn,$que);
                            	
                            if($query)
                            {                                
                                echo '<script>window.location.href="list_terms.php";alert("Updated Successfully");</script>';
                       
                            }
                            else
                            {
                                echo "<font color='green'>Error While Updating Subject </font>";	
                            }
   ...
   <?php if(isset($_GET['term_id']))
   {
       ...
       $q=mysqli_query($conn,"SELECT term_name,status FROM term WHERE term_id='$term_id'");
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Terms Management <small>Update Term </small></h2>
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="selclass">Term name<span class="required" style="color:red;">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="term_name" class="form-control col-md-7 col-xs-12"  name="term_name" value="<?php echo $row['term_name']; ?>"/>
                      ...
                      <input type="text" name="term_id" id="term_id" value="<?php echo $term_id; ?>" hidden>
                      <div class="item form-group">
