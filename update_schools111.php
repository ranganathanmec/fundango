...
.tab-content>.in {
 ...
 <!--  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
  ...
  { 
      ...
      $qx=mysqli_query($conn,"select school_name,no_of_class,status from school where school_id='$sch_id'");
                    ...
                    if(intval($no_of_classes)>=1 && intval($no_of_classes)<=12)   
                        {
                            ...
                            $que="UPDATE `school` `school_name`='$school_name', `no_of_class`=$no_of_classes,`status`='$status' where school_id=$_id" ;
                        ...
                        echo "<font color='green' style='margin-left:400px;'>Enter Valid Number of classes</font>";
                    }
    ...
    <div id="home" class="tab-pane fade in active">
      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="school_name" class="form-control col-md-7 col-xs-12"  name="school_name" value="<?php echo $sc_name ?>" >
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						 ...
						 <input type="number" id="no_of_classes"  class="form-control col-md-7 col-xs-12"  name="no_of_classes" min="1" max="12" value="<?php echo $sc_no_class; ?>" >
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <?php if($status=='1'){ ?>
                            <option value="<?php $status;?>" selected >Active</option>
